...
<!--file lay  out nay de dinh nghia bo cuc trang cua web khi header va footer ko thay doi chi co body thay doi-->
<!-- do do ta se su dung jsp include -->
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
                    ...
                    <div class="col-lg-9">
                        <div class="hero__search">
                            <div class="hero__search__form">
                                <form action="./products?page=1">
                                    <input type="text" placeholder="What do yo u need?" name="q">
        ...
        <!--view dc tra ra tu cac controller nen tu do layout co the vt dc rang phan body cua router dc tra ra ntn-->
